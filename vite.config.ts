    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          description: 'Seu universo de animes em um só lugar. Organize, descubra e acompanhe seus animes favoritos.',
          theme_color: '#1e293b',
        ...
        workbox: {
          globPatterns: ['**/*.{js,css,html,ico,png,svg,woff2}'], // Cache these assets
          runtimeCaching: [
            {
